package com.kykint.dream7.controlcenter.prefs;
...
import com.kykint.dream7.controlcenter.utils.AppInfo;
import com.kykint.dream7.controlcenter.utils.AppListTask;
...
public class IntentDialogPreference extends DialogPreference implements AdapterView.OnItemClickListener, AppListTask.OnListCreatedListener {
    ...
    @Override
    public void onListCreated(List<com.kykint.dream7.controlcenter.utils.AppInfo> appInfoList) {
